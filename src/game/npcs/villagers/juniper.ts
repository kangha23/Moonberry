...
export const JUNIPER: NpcDef = {
  ...
  dialogue: [
    ...
    { priority: 20, when: { season: 'Winter' }, line: '"Rễ đông với cải tuyết nằm ngay dưới lớp tuyết. Phải biết chỗ mà bới."' },
    ...
    { priority: 50, when: { minHearts: 6 }, line: '"Có một bãi rễ đông tôi mới chỉ cho đúng một người. Ông ấy mất rồi, nên con số quay về một."' },
